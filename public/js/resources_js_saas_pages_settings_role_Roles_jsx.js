"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_saas_pages_settings_role_Roles_jsx"],{

/***/ "./resources/js/saas/pages/settings/role/Roles.jsx":
/*!*********************************************************!*\
  !*** ./resources/js/saas/pages/settings/role/Roles.jsx ***!
  \*********************************************************/
...
/* harmony import */ var react_bootstrap__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! react-bootstrap */ "./node_modules/react-bootstrap/esm/DropdownButton.js");
/* harmony import */ var react_bootstrap__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! react-bootstrap */ "./node_modules/react-bootstrap/esm/Dropdown.js");
...
function Roles(props) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().get((0,_Context__WEBPACK_IMPORTED_MODULE_3__.SecureApiUrl)("get-roles"), {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              setRefreshingList(true);
              _context2.next = 5;
              return axios__WEBPACK_IMPORTED_MODULE_0___default().get((0,_Context__WEBPACK_IMPORTED_MODULE_3__.SecureApiUrl)("get-roles?src=".concat(srcKey)), {
                headers: (0,_Context__WEBPACK_IMPORTED_MODULE_3__.Header)()
              }).then(function (response) {
                var info = response.data;
                if (info.deny) {
                    ...
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          ...
                          form.append('id', id);
                          _context4.next = 5;
                          return axios__WEBPACK_IMPORTED_MODULE_0___default().post((0,_Context__WEBPACK_IMPORTED_MODULE_3__.SecureApiUrl)("block-role"), form, {
                            headers: (0,_Context__WEBPACK_IMPORTED_MODULE_3__.Header)()
                          }).then(function (response) {
                    ...
                    while (1) {
                      switch (_context6.prev = _context6.next) {
                        case 0:
                          ...
                          form.append('id', id);
                          _context6.next = 5;
                          return axios__WEBPACK_IMPORTED_MODULE_0___default().post((0,_Context__WEBPACK_IMPORTED_MODULE_3__.SecureApiUrl)("unblock-role"), form, {
                            headers: (0,_Context__WEBPACK_IMPORTED_MODULE_3__.Header)()
                          }).then(function (response) {
                            handleGetStartUpData();
                            var info = response.data;
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_6__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_7__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_8__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_8__["default"].Header, {
  ...
  }, page.card_title, page.can_save ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_9__.Link, {
    to: (0,_Context__WEBPACK_IMPORTED_MODULE_3__.SecureUrl)("user-settings/role"),
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("tr", {
      key: index
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("td", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", {
      className: info.deleted_at ? "text-decoration-line-through" : ""
    }, props.lang == 'en' ? info.name : info.name_l ? info.name_l : info.name)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("td", null, Object.keys(info.users).length > 0 ? Object.values(info.users).map(function (user, ui) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", {
        key: ui,
        className: info.deleted_at ? "text-decoration-line-through" : ""
      }, user.name, " (", user.email, ")", Object.keys(info.users).length != ui + 1 ? ", " : " ");
    }) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", {
      className: "text-warning"
    }, "No User Assigned")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("td", null, !page.can_save && !page.can_block ? "" : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_13__["default"], {
      title: page.btn_action,
      className: "btn-sm float-end"
    }, !page.can_save || info.deleted_at ? "" : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_9__.Link, {
      to: (0,_Context__WEBPACK_IMPORTED_MODULE_3__.SecureUrl)("user-settings/role/".concat(info.id)),
      className: "dropdown-item",
      "aria-selected": "false"
    }, page.btn_edit), !page.can_block ? "" : info.deleted_at ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_14__["default"].Item, {
      eventKey: "2",
      onClick: function onClick() {
        return handleUnblock(info.id);
      }
    }, page.btn_unblock) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_14__["default"].Item, {
      eventKey: "2",
      onClick: function onClick() {
    ...
    }, paginate.label == "&laquo; Previous" ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_9__.Link, {
      to: "#",
      className: "page-link",
    ...
    })) : paginate.label == "Next &raquo;" ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_9__.Link, {
      to: "#",
      className: "page-link",
      onClick: function onClick(e) {
        e.preventDefault();
    ...
    })) : paginate.label == "..." ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_9__.Link, {
      to: "#",
      className: "page-link",
      onClick: function onClick(e) {
        return e.preventDefault();
      }
    }, paginate.label) : !paginate.active ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_9__.Link, {
      to: "#",
      className: "page-link",
      onClick: function onClick(e) {
        e.preventDefault();
