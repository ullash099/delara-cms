...
export default function BlogCategories(props) {
    ...
    const handleSavingInfo = async () => {
        ...
        await axios.post(SecureApiUrl(`save-blog-category`),form,{headers:Header()})
        .then(function (response) {
            setSavingData(false)
            let info = response.data
    ...
    const handleBlock = async (id) => {
        ...
        .then(async (res) => {
            if (res.isConfirmed) {
                ...
                const form = new FormData()
                form.append('id', id)
                await axios.post(SecureApiUrl(`block-blog-category`),form,{headers : Header()})
                .then(function (response) {
                    handleGetStartUpData()
                    let info = response.data
    ...
    const handleUnblock = async (id) => {
        ...
        .then(async (res) => {
            if (res.isConfirmed) {
                ...
                const form = new FormData()
                form.append('id', id)
                await axios.post(SecureApiUrl(`unblock-blog-category`),form,{headers : Header()})
                .then(function (response) {
                    handleGetStartUpData()
                    let info = response.data
