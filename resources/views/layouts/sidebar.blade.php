<div class="leftside-menu menuitem-active">
    ...
    <div class="h-100 show" id="leftside-menu-container" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px;">
        ...
        <div class="leftbar-user">
            <a href="pages-profile.html">
                <img src="assets/images/users/avatar-1.jpg" alt="user-image" class="rounded-circle shadow-sm" height="42">
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item menuitem-active">
                ...
                <div class="collapse show" id="sidebarExtendedUI">
                    <ul class="side-nav-second-level">
                        <li class="menuitem-active">
                            <a href="extended-dragula.html" class="active">Dragula</a>
                        </li>
                        <li>
            ...
            <div class="help-box text-white text-center">
                ...
                <img src="assets/images/svg/help-icon.svg" alt="Helper Icon Image" height="90">
    ...
    </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 1987px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 41px; transform: translate3d(0px, 98px, 0px); display: block;"></div></div></div>
</div>